...
const runManagedBenchmark = async (bench, managedTimer, count) => {
...
const runUnmanagedBenchmark = async (bench, unmanagedTimer) => {
...
function createRunner(bench, recommendedCount) {
  const fnString = StringPrototypeToString(bench.fn);
