...
E('ERR_BENCH_HISTOGRAM_FINISHED', 'Is not possible to change the state of histogram after finish.', Error);
E('ERR_BENCH_HISTOGRAM_NOT_FINISHED', 'Is not possible to read the state of histogram before finish.', Error);
